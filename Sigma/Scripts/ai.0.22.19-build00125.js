...
(function (AI) {
    ...
    var ContextTagKeys = (function () {
        function ContextTagKeys() {
            ...
            this.userAccountAcquisitionDate = "ai.users.accountAcquisitionDate";
            this.userAccountId = "ai.users.accountId";
            this.userAgent = "ai.users.userAgent";
            this.userId = "ai.users.id";
            this.userStoreRegion = "ai.users.storeRegion";
            this.userAuthUserId = "ai.users.authUserId";
            this.userAnonymousUserAcquisitionDate = "ai.users.anonUserAcquisitionDate";
            this.userAuthenticatedUserAcquisitionDate = "ai.users.authUserAcquisitionDate";
        ...
        (function (Context) {
            ...
            var User = (function () {
                ...
                User.prototype.setAuthenticatedUserContext = function (authenticatedUserId, accountId) {
                    ...
                    if (isInvalidInput) {
                        ApplicationInsights._InternalLogging.throwInternalUserActionable(ApplicationInsights.LoggingSeverity.WARNING, new ApplicationInsights._InternalLogMessage(ApplicationInsights._InternalMessageId.USRACT_SetAuthContextFailedAccountName, "Setting auth users context failed. " +
        ...
        var AppInsights = (function () {
            ...
            AppInsights.prototype.setAuthenticatedUserContext = function (authenticatedUserId, accountId) {
                try {
                    ...
                    ApplicationInsights._InternalLogging.throwInternalUserActionable(ApplicationInsights.LoggingSeverity.WARNING, new ApplicationInsights._InternalLogMessage(ApplicationInsights._InternalMessageId.USRACT_SetAuthContextFailed, "Setting auth users context failed. " + ApplicationInsights.Util.getExceptionName(e), { exception: ApplicationInsights.Util.dump(e) }));
                }
            };
            AppInsights.prototype.clearAuthenticatedUserContext = function () {
                try {
                    ...
                    ApplicationInsights._InternalLogging.throwInternalUserActionable(ApplicationInsights.LoggingSeverity.WARNING, new ApplicationInsights._InternalLogMessage(ApplicationInsights._InternalMessageId.USRACT_SetAuthContextFailed, "Clearing auth users context failed. " + ApplicationInsights.Util.getExceptionName(e), { exception: ApplicationInsights.Util.dump(e) }));
                }
            };
    ...
    (function (ApplicationInsights) {
        ...
        var Initialization = (function () {
            ...
            Initialization.prototype.addHousekeepingBeforeUnload = function (appInsightsInstance) {
                // Add callback to push events when the users navigates away
